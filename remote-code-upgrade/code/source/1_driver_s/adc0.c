...
/*****************************************************************************
 ** \brief	ADC0_EnableHardwareTigger
 **			开启硬件触发ADC0转换功能
 ** \param [in] TiggerSource: (1)ADC0_TG_EXT_FALLING
 ...
 ** \note	
*****************************************************************************/
void ADC0_EnableHardwareTigger(uint32_t TiggerSource)
{
	ADC0->LOCK = ADC0_LOCK_WRITE_KEY;
	switch(TiggerSource)
	{
...
/*****************************************************************************
 ** \brief	ADC0_DisableHardwareTigger
 **			关闭硬件触发ADC0转换功能
 ** \param [in] TiggerSource: (1)ADC0_TG_EXT_FALLING
 **							(2)ADC0_TG_EXT_RISING
 **							(3)ADC0_TG_INTNEL_ADC0
 ...
 ** \note	
*****************************************************************************/
void ADC0_DisableHardwareTigger(uint32_t TiggerSource)
{
	ADC0->LOCK = ADC0_LOCK_WRITE_KEY;
	switch(TiggerSource)
	{
