...
#define 	GPIO_PIN_1			(0x01UL)		/*GPIO Pin 0 Num*/
#define 	GPIO_PIN_2			(0x02UL)		/*GPIO Pin 0 Num*/
#define 	GPIO_PIN_3			(0x03UL)		/*GPIO Pin 0 Num*/
#define 	GPIO_PIN_4			(0x04UL)		/*GPIO Pin 0 Num*/		
#define 	GPIO_PIN_5			(0x05UL)		/*GPIO Pin 0 Num*/
#define 	GPIO_PIN_6			(0x06UL)		/*GPIO Pin 0 Num*/
#define 	GPIO_PIN_7			(0x07UL)		/*GPIO Pin 0 Num*/
...
/*****************************************************************************
 ** \brief	 GPIO_GET_INPUT_PIN
 **			 获取IO状态
 ** \param [in] port : GPIO0、GPIO1 、GPIO2、GPIO3、GPIO4
 **				PinNum: GPIO_PIN_0 ~ GPIO_PIN_7
 ** \return 0:输入低电平， 1：输入高电平
 ** \note	 
*****************************************************************************/
#define   GPIO_GET_INPUT_PIN(port,PinNum)  (((port->DI & (0x1UL<<PinNum))? 1:0))
 ...
 ** \note	
*****************************************************************************/
void GPIO_DisableInt(GPIO_T *port, uint32_t Pin);
