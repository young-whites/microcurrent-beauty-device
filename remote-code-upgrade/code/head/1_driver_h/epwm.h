 ...
 **EPWM 时钟
-----------------------------------------------------------------------------*/
#define 	EPWM_CLK_PCLK					(0x5UL)		
#define 	EPWM_CLK_DIV_1				(0x4UL)		
#define	 	EPWM_CLK_DIV_2				(0x0UL)		
#define	 	EPWM_CLK_DIV_4				(0x1UL)		
#define 	EPWM_CLK_DIV_8				(0x2UL)		
#define 	EPWM_CLK_DIV_16				(0x3UL)		
...
#define 	EPWM_BRK_EXT			(EPWM_BRKCTL_EXTBRKLE_Msk|EPWM_BRKCTL_EXTBRKEE_Msk)			/*外部硬件刹车*/
#define 	EPWM_BRK_ADC1CMP0		(EPWM_BRKCTL_ADC1PM0BKEN_Msk)		/*ADC1比较器0刹车*/
#define 	EPWM_BRK_ADC1CMP1		(EPWM_BRKCTL_ADC1PM1BKEN_Msk)		/*ADC1比较器1刹车*/	
#define 	EPWM_BRK_ADC0CMP0		(EPWM_BRKCTL_ADC0PM0BKEN_Msk)		/*ADC0比较器0刹车*/
#define 	EPWM_BRK_ACMP0			(EPWM_BRKCTL_ACMP0BKEN_Msk)			/*模拟比较器0事件刹车*/
#define 	EPWM_BRK_ACMP1			(EPWM_BRKCTL_ACMP1BKEN_Msk)			/*模拟比较器1事件刹车*/	
/*----------------------------------------------------------------------------
 **EPWM  外部硬件刹车
-----------------------------------------------------------------------------*/
